...
export const JinnoCard = ({ character, getImageClass, handleConnectClick, handleDeleteClick, isActive, maxAttributeValue }: SelectionCardProps) => {
    return (
        <>
            {
                character &&
                <section className="text-orange-200  pl-[1.5rem] pt-[6rem] w-[550px] h-[550px]  bg-[length:100%_100%] bg-[url('/modal/jinno-character-modal.png')] bg-center bg-no-repeat">
                    <section className="grid relative  grid-cols-[45%_auto] mb-3 mt-7">
                    ...
                    <p className="text-center w-[92%] ml-2">Stats</p>
                    ...
                    <div className="flex w-[92%] ml-2 justify-center mt-5">
                        <NetimButton onClickButtom={handleConnectClick} text="Jugar" />
                    </div>
                    <div className="flex justify-end mt-6 mr-21 ">
