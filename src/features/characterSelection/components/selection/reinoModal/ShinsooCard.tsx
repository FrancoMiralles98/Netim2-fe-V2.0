...
export const ShinsooCard = ({ character, maxAttributeValue, isActive, getImageClass, handleConnectClick, handleDeleteClick }: SelectionCardProps) => {
    return (
        <>
            {
                character &&
                <section className="text-orange-200 pl-[1.5rem] pt-[6rem] w-[550px] h-[550px]  bg-[length:100%_100%] bg-[url('/modal/shinsoo-character-modal.png')] bg-center bg-no-repeat">
                    <section className="grid relative grid-cols-[45%_auto] mb-3 mt-4">
                    ...
                    <div className="grid w-[95%] grid-cols-2">
                    ...
                    <div className="flex justify-end ml-1 mt-3 mr-8 ">
